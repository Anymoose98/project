                            ...
                            <div class="col-6 mb-3">
                                <div class="px-2">
                                    ...
                                    <input v-model="team.nome" class="form-control" type="text" id="nomeTeam"
                                        placeholder="Inserisci il nome del tuo team" aria-label="default input example" required>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="px-2">
                                    ...
                                    <input v-model="team.membri" class="form-control" type="number" id="membri"
                                        placeholder="Inserisci il numero di membri" aria-label="default input example" required>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="px-2">
                                    <label for="punteggioTeam" class="form-label">Punteggio</label>
                                    <input v-model="team.punteggioTeam" class="form-control" type="number" id="punteggioTeam"
                                        placeholder="Punteggio complessivo del team" aria-label="default input example" required>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="px-2">
                                    <label for="torneiVinti" class="form-label">Tornei vinti</label>
                                    <input v-model="team.torneiVinti" class="form-control" type="number" id="torneiVinti"
                                        placeholder="Numero di tornei vinti" aria-label="default input example" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 text-center">
